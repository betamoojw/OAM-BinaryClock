...
#define MAIN_ParameterSize 11383
#define MAIN_MaxKoNumber 346
#define MAIN_OrderNumber "OpenKnxBinaryClock"
...
#define BIN_StartBrightness                     46      // 2 Bits, Bit 7-6
#define     BIN_StartBrightnessMask 0xC0
#define     BIN_StartBrightnessShift 6
#define BIN_StartBrightnessFixedValue           47      // uint8_t
#define BIN_StartBrightnessFixedValueDay        47      // uint8_t
#define BIN_StartBrightnessFixedValueNight      48      // uint8_t
#define BIN_InactiveBitsBrightness              49      // 2 Bits, Bit 7-6
#define     BIN_InactiveBitsBrightnessMask 0xC0
#define     BIN_InactiveBitsBrightnessShift 6
#define BIN_InactiveBitsBrightnessFixedValue    50      // uint8_t
#define BIN_InactiveBitsBrightnessFixedValueDay 50      // uint8_t
#define BIN_InactiveBitsBrightnessFixedValueNight 51      // uint8_t
#define BIN_InactiveBitsBrightnessPercentActive 52      // uint8_t

// Einschaltverhalten
#define ParamBIN_StartBrightness                     ((knx.paramByte(BIN_StartBrightness) & BIN_StartBrightnessMask) >> BIN_StartBrightnessShift)
// Einschalthelligkeit
#define ParamBIN_StartBrightnessFixedValue           (knx.paramByte(BIN_StartBrightnessFixedValue))
// Einschalthelligkeit Tag
#define ParamBIN_StartBrightnessFixedValueDay        (knx.paramByte(BIN_StartBrightnessFixedValueDay))
// Einschalthelligkeit Nacht
#define ParamBIN_StartBrightnessFixedValueNight      (knx.paramByte(BIN_StartBrightnessFixedValueNight))
// Helligkeit inaktiver Bits
#define ParamBIN_InactiveBitsBrightness              ((knx.paramByte(BIN_InactiveBitsBrightness) & BIN_InactiveBitsBrightnessMask) >> BIN_InactiveBitsBrightnessShift)
// Helligkeit
#define ParamBIN_InactiveBitsBrightnessFixedValue    (knx.paramByte(BIN_InactiveBitsBrightnessFixedValue))
// Helligkeit Tag
#define ParamBIN_InactiveBitsBrightnessFixedValueDay (knx.paramByte(BIN_InactiveBitsBrightnessFixedValueDay))
// Helligkeit Nacht
#define ParamBIN_InactiveBitsBrightnessFixedValueNight (knx.paramByte(BIN_InactiveBitsBrightnessFixedValueNight))
// Prozent Helligkeit aktiver Bits
#define ParamBIN_InactiveBitsBrightnessPercentActive (knx.paramByte(BIN_InactiveBitsBrightnessPercentActive))

#define BIN_KoSwitch 451
#define BIN_KoSwitchStatus 456
#define BIN_KoDimAbsolute 461
#define BIN_KoDimRelative 462
#define BIN_KoBrightnessStatus 466

// 
#define KoBIN_Switch                              (knx.getGroupObject(BIN_KoSwitch))
// 
#define KoBIN_SwitchStatus                        (knx.getGroupObject(BIN_KoSwitchStatus))
// 
#define KoBIN_DimAbsolute                         (knx.getGroupObject(BIN_KoDimAbsolute))
// 
#define KoBIN_DimRelative                         (knx.getGroupObject(BIN_KoDimRelative))
// 
#define KoBIN_BrightnessStatus                    (knx.getGroupObject(BIN_KoBrightnessStatus))

#define LOG_BuzzerInstalled                     54      // 1 Bit, Bit 7
#define     LOG_BuzzerInstalledMask 0x80
#define     LOG_BuzzerInstalledShift 7
#define LOG_LedInstalled                        54      // 1 Bit, Bit 6
#define     LOG_LedInstalledMask 0x40
#define     LOG_LedInstalledShift 6
#define LOG_VacationKo                          54      // 1 Bit, Bit 5
#define     LOG_VacationKoMask 0x20
#define     LOG_VacationKoShift 5
#define LOG_HolidayKo                           54      // 1 Bit, Bit 4
#define     LOG_HolidayKoMask 0x10
#define     LOG_HolidayKoShift 4
#define LOG_VacationRead                        54      // 1 Bit, Bit 3
#define     LOG_VacationReadMask 0x08
#define     LOG_VacationReadShift 3
#define LOG_HolidaySend                         54      // 1 Bit, Bit 2
#define     LOG_HolidaySendMask 0x04
#define     LOG_HolidaySendShift 2
#define LOG_Neujahr                             55      // 1 Bit, Bit 7
#define     LOG_NeujahrMask 0x80
#define     LOG_NeujahrShift 7
#define LOG_DreiKoenige                         55      // 1 Bit, Bit 6
#define     LOG_DreiKoenigeMask 0x40
#define     LOG_DreiKoenigeShift 6
#define LOG_Weiberfastnacht                     55      // 1 Bit, Bit 5
#define     LOG_WeiberfastnachtMask 0x20
#define     LOG_WeiberfastnachtShift 5
#define LOG_Rosenmontag                         55      // 1 Bit, Bit 4
#define     LOG_RosenmontagMask 0x10
#define     LOG_RosenmontagShift 4
#define LOG_Fastnachtsdienstag                  55      // 1 Bit, Bit 3
#define     LOG_FastnachtsdienstagMask 0x08
#define     LOG_FastnachtsdienstagShift 3
#define LOG_Aschermittwoch                      55      // 1 Bit, Bit 2
#define     LOG_AschermittwochMask 0x04
#define     LOG_AschermittwochShift 2
#define LOG_Frauentag                           55      // 1 Bit, Bit 1
#define     LOG_FrauentagMask 0x02
#define     LOG_FrauentagShift 1
#define LOG_Gruendonnerstag                     55      // 1 Bit, Bit 0
#define     LOG_GruendonnerstagMask 0x01
#define     LOG_GruendonnerstagShift 0
#define LOG_Karfreitag                          56      // 1 Bit, Bit 7
#define     LOG_KarfreitagMask 0x80
#define     LOG_KarfreitagShift 7
#define LOG_Ostersonntag                        56      // 1 Bit, Bit 6
#define     LOG_OstersonntagMask 0x40
#define     LOG_OstersonntagShift 6
#define LOG_Ostermontag                         56      // 1 Bit, Bit 5
#define     LOG_OstermontagMask 0x20
#define     LOG_OstermontagShift 5
#define LOG_TagDerArbeit                        56      // 1 Bit, Bit 4
#define     LOG_TagDerArbeitMask 0x10
#define     LOG_TagDerArbeitShift 4
#define LOG_Himmelfahrt                         56      // 1 Bit, Bit 3
#define     LOG_HimmelfahrtMask 0x08
#define     LOG_HimmelfahrtShift 3
#define LOG_Pfingstsonntag                      56      // 1 Bit, Bit 2
#define     LOG_PfingstsonntagMask 0x04
#define     LOG_PfingstsonntagShift 2
#define LOG_Pfingstmontag                       56      // 1 Bit, Bit 1
#define     LOG_PfingstmontagMask 0x02
#define     LOG_PfingstmontagShift 1
#define LOG_Fronleichnam                        56      // 1 Bit, Bit 0
#define     LOG_FronleichnamMask 0x01
#define     LOG_FronleichnamShift 0
#define LOG_Friedensfest                        57      // 1 Bit, Bit 7
#define     LOG_FriedensfestMask 0x80
#define     LOG_FriedensfestShift 7
#define LOG_MariaHimmelfahrt                    57      // 1 Bit, Bit 6
#define     LOG_MariaHimmelfahrtMask 0x40
#define     LOG_MariaHimmelfahrtShift 6
#define LOG_DeutscheEinheit                     57      // 1 Bit, Bit 5
#define     LOG_DeutscheEinheitMask 0x20
#define     LOG_DeutscheEinheitShift 5
#define LOG_Nationalfeiertag                    58      // 1 Bit, Bit 1
#define     LOG_NationalfeiertagMask 0x02
#define     LOG_NationalfeiertagShift 1
#define LOG_Reformationstag                     57      // 1 Bit, Bit 4
#define     LOG_ReformationstagMask 0x10
#define     LOG_ReformationstagShift 4
#define LOG_Allerheiligen                       57      // 1 Bit, Bit 3
#define     LOG_AllerheiligenMask 0x08
#define     LOG_AllerheiligenShift 3
#define LOG_BussBettag                          57      // 1 Bit, Bit 2
#define     LOG_BussBettagMask 0x04
#define     LOG_BussBettagShift 2
#define LOG_MariaEmpfaengnis                    58      // 1 Bit, Bit 0
#define     LOG_MariaEmpfaengnisMask 0x01
#define     LOG_MariaEmpfaengnisShift 0
#define LOG_Advent1                             57      // 1 Bit, Bit 1
#define     LOG_Advent1Mask 0x02
#define     LOG_Advent1Shift 1
#define LOG_Advent2                             57      // 1 Bit, Bit 0
#define     LOG_Advent2Mask 0x01
#define     LOG_Advent2Shift 0
#define LOG_Advent3                             58      // 1 Bit, Bit 7
#define     LOG_Advent3Mask 0x80
#define     LOG_Advent3Shift 7
#define LOG_Advent4                             58      // 1 Bit, Bit 6
#define     LOG_Advent4Mask 0x40
#define     LOG_Advent4Shift 6
#define LOG_Heiligabend                         58      // 1 Bit, Bit 5
#define     LOG_HeiligabendMask 0x20
#define     LOG_HeiligabendShift 5
#define LOG_Weihnachtstag1                      58      // 1 Bit, Bit 4
#define     LOG_Weihnachtstag1Mask 0x10
#define     LOG_Weihnachtstag1Shift 4
#define LOG_Weihnachtstag2                      58      // 1 Bit, Bit 3
#define     LOG_Weihnachtstag2Mask 0x08
#define     LOG_Weihnachtstag2Shift 3
#define LOG_Silvester                           58      // 1 Bit, Bit 2
#define     LOG_SilvesterMask 0x04
#define     LOG_SilvesterShift 2
#define LOG_BuzzerSilent                        59      // uint16_t
#define LOG_BuzzerNormal                        61      // uint16_t
#define LOG_BuzzerLoud                          63      // uint16_t
#define LOG_VisibleChannels                     65      // uint8_t
#define LOG_LedMapping                          66      // 3 Bits, Bit 7-5
#define     LOG_LedMappingMask 0xE0
#define     LOG_LedMappingShift 5
#define LOG_UserFormula1                        67      // char*, 99 Byte
#define LOG_UserFormula1Active                  166      // 1 Bit, Bit 7
#define     LOG_UserFormula1ActiveMask 0x80
#define     LOG_UserFormula1ActiveShift 7
#define LOG_UserFormula2                        167      // char*, 99 Byte
#define LOG_UserFormula2Active                  266      // 1 Bit, Bit 7
#define     LOG_UserFormula2ActiveMask 0x80
#define     LOG_UserFormula2ActiveShift 7
#define LOG_UserFormula3                        267      // char*, 99 Byte
#define LOG_UserFormula3Active                  366      // 1 Bit, Bit 7
#define     LOG_UserFormula3ActiveMask 0x80
#define     LOG_UserFormula3ActiveShift 7
#define LOG_UserFormula4                        367      // char*, 99 Byte
#define LOG_UserFormula4Active                  466      // 1 Bit, Bit 7
#define     LOG_UserFormula4ActiveMask 0x80
#define     LOG_UserFormula4ActiveShift 7
#define LOG_UserFormula5                        467      // char*, 99 Byte
#define LOG_UserFormula5Active                  566      // 1 Bit, Bit 7
#define     LOG_UserFormula5ActiveMask 0x80
#define     LOG_UserFormula5ActiveShift 7
#define LOG_UserFormula6                        567      // char*, 99 Byte
#define LOG_UserFormula6Active                  666      // 1 Bit, Bit 7
#define     LOG_UserFormula6ActiveMask 0x80
#define     LOG_UserFormula6ActiveShift 7
#define LOG_UserFormula7                        667      // char*, 99 Byte
#define LOG_UserFormula7Active                  766      // 1 Bit, Bit 7
#define     LOG_UserFormula7ActiveMask 0x80
#define     LOG_UserFormula7ActiveShift 7
#define LOG_UserFormula8                        767      // char*, 99 Byte
#define LOG_UserFormula8Active                  866      // 1 Bit, Bit 7
#define     LOG_UserFormula8ActiveMask 0x80
#define     LOG_UserFormula8ActiveShift 7
#define LOG_UserFormula9                        867      // char*, 99 Byte
#define LOG_UserFormula9Active                  966      // 1 Bit, Bit 7
#define     LOG_UserFormula9ActiveMask 0x80
#define     LOG_UserFormula9ActiveShift 7
#define LOG_UserFormula10                       967      // char*, 99 Byte
#define LOG_UserFormula10Active                 1066      // 1 Bit, Bit 7
#define     LOG_UserFormula10ActiveMask 0x80
#define     LOG_UserFormula10ActiveShift 7
#define LOG_UserFormula11                       1067      // char*, 99 Byte
#define LOG_UserFormula11Active                 1166      // 1 Bit, Bit 7
#define     LOG_UserFormula11ActiveMask 0x80
#define     LOG_UserFormula11ActiveShift 7
#define LOG_UserFormula12                       1167      // char*, 99 Byte
#define LOG_UserFormula12Active                 1266      // 1 Bit, Bit 7
#define     LOG_UserFormula12ActiveMask 0x80
#define     LOG_UserFormula12ActiveShift 7
#define LOG_UserFormula13                       1267      // char*, 99 Byte
#define LOG_UserFormula13Active                 1366      // 1 Bit, Bit 7
#define     LOG_UserFormula13ActiveMask 0x80
#define     LOG_UserFormula13ActiveShift 7
#define LOG_UserFormula14                       1367      // char*, 99 Byte
#define LOG_UserFormula14Active                 1466      // 1 Bit, Bit 7
#define     LOG_UserFormula14ActiveMask 0x80
#define     LOG_UserFormula14ActiveShift 7
#define LOG_UserFormula15                       1467      // char*, 99 Byte
#define LOG_UserFormula15Active                 1566      // 1 Bit, Bit 7
#define     LOG_UserFormula15ActiveMask 0x80
#define     LOG_UserFormula15ActiveShift 7
#define LOG_UserFormula16                       1567      // char*, 99 Byte
#define LOG_UserFormula16Active                 1666      // 1 Bit, Bit 7
#define     LOG_UserFormula16ActiveMask 0x80
#define     LOG_UserFormula16ActiveShift 7
#define LOG_UserFormula17                       1667      // char*, 99 Byte
#define LOG_UserFormula17Active                 1766      // 1 Bit, Bit 7
#define     LOG_UserFormula17ActiveMask 0x80
#define     LOG_UserFormula17ActiveShift 7
#define LOG_UserFormula18                       1767      // char*, 99 Byte
#define LOG_UserFormula18Active                 1866      // 1 Bit, Bit 7
#define     LOG_UserFormula18ActiveMask 0x80
#define     LOG_UserFormula18ActiveShift 7
#define LOG_UserFormula19                       1867      // char*, 99 Byte
#define LOG_UserFormula19Active                 1966      // 1 Bit, Bit 7
#define     LOG_UserFormula19ActiveMask 0x80
#define     LOG_UserFormula19ActiveShift 7
#define LOG_UserFormula20                       1967      // char*, 99 Byte
#define LOG_UserFormula20Active                 2066      // 1 Bit, Bit 7
#define     LOG_UserFormula20ActiveMask 0x80
#define     LOG_UserFormula20ActiveShift 7
#define LOG_UserFormula21                       2067      // char*, 99 Byte
#define LOG_UserFormula21Active                 2166      // 1 Bit, Bit 7
#define     LOG_UserFormula21ActiveMask 0x80
#define     LOG_UserFormula21ActiveShift 7
#define LOG_UserFormula22                       2167      // char*, 99 Byte
#define LOG_UserFormula22Active                 2266      // 1 Bit, Bit 7
#define     LOG_UserFormula22ActiveMask 0x80
#define     LOG_UserFormula22ActiveShift 7
#define LOG_UserFormula23                       2267      // char*, 99 Byte
#define LOG_UserFormula23Active                 2366      // 1 Bit, Bit 7
#define     LOG_UserFormula23ActiveMask 0x80
#define     LOG_UserFormula23ActiveShift 7
#define LOG_UserFormula24                       2367      // char*, 99 Byte
#define LOG_UserFormula24Active                 2466      // 1 Bit, Bit 7
#define     LOG_UserFormula24ActiveMask 0x80
#define     LOG_UserFormula24ActiveShift 7
#define LOG_UserFormula25                       2467      // char*, 99 Byte
#define LOG_UserFormula25Active                 2566      // 1 Bit, Bit 7
#define     LOG_UserFormula25ActiveMask 0x80
#define     LOG_UserFormula25ActiveShift 7
#define LOG_UserFormula26                       2567      // char*, 99 Byte
#define LOG_UserFormula26Active                 2666      // 1 Bit, Bit 7
#define     LOG_UserFormula26ActiveMask 0x80
#define     LOG_UserFormula26ActiveShift 7
#define LOG_UserFormula27                       2667      // char*, 99 Byte
#define LOG_UserFormula27Active                 2766      // 1 Bit, Bit 7
#define     LOG_UserFormula27ActiveMask 0x80
#define     LOG_UserFormula27ActiveShift 7
#define LOG_UserFormula28                       2767      // char*, 99 Byte
#define LOG_UserFormula28Active                 2866      // 1 Bit, Bit 7
#define     LOG_UserFormula28ActiveMask 0x80
#define     LOG_UserFormula28ActiveShift 7
#define LOG_UserFormula29                       2867      // char*, 99 Byte
#define LOG_UserFormula29Active                 2966      // 1 Bit, Bit 7
#define     LOG_UserFormula29ActiveMask 0x80
#define     LOG_UserFormula29ActiveShift 7
#define LOG_UserFormula30                       2967      // char*, 99 Byte
#define LOG_UserFormula30Active                 3066      // 1 Bit, Bit 7
...
#define LOG_ParamBlockOffset 3067
...
#define BASE_KommentarModuleParamOffset 11383
